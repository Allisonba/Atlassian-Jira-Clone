...
const EighthBox = () => {
  return (
    <div className="eighthbox">
        <div>
            <img src={one} alt="djdh" className="eighthimg"
            />
        ...
        <div>
            <img src={two} alt="djdh" className="eighthimg"/>
        ...
        <div>
            <img src={three} alt="djdh" className="eighthimg"/>
        ...
        <div>
            <img src={four} alt="djdh" className="eighthimg"/>
